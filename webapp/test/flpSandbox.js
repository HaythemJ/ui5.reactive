		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ui5 Reactive",
									"targetURL": "#sampleui5reactive-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sampleui5reactive-display": {
								"semanticObject": "sampleui5reactive",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sample.ui5.reactive",
									"url": sap.ui.require.toUrl("sample/ui5/reactive")
								}
							}
						}
					}
